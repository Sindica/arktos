...
func Run(ctx context.Context, cc *schedulerserverconfig.CompletedConfig, sched *scheduler.Scheduler) error {
	...
	klog.V(1).Infof("Starting Kubernetes Scheduler version %+v, QPS %v, Burst %v", version.Get(), cc.ComponentConfig.ClientConnection.QPS, cc.ComponentConfig.ClientConnection.Burst)
